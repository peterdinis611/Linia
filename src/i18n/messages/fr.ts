...
export const fr: Messages = {
  meta: {
    ...
    shareBoardTitle: "{from} — tableau Linia",
    shareBoardDescription: "Départs en direct depuis {from}.",
    keywords:
  ...
  search: {
    ...
    modeCoach: "Bus",
    city: "Ville",
    cityPlaceholder: "Prešov, Košice, Lyon…",
    cityKicker: "Guichet ville",
    cityHint: "D’abord la ville. Puis longue distance ou banlieue.",
    suburbanHint: "Tampon de et vers. La carte épingle les deux arrêts et la ligne de banlieue.",
    distanceGroup: "Type de ligne",
    distanceLong: "Longue distance",
    distanceSuburban: "Banlieue",
    originSuburbanPlaceholder: "Village ou arrêt",
    destinationSuburbanPlaceholder: "Terminus de la ligne de banlieue",
    ...
    pickFromList: "Choisissez un lieu dans la liste",
    noPlaces: "Aucun lieu. Essayez une gare ou une ville.",
    returnTrip: "Retour",
    returnKicker: "Tampon retour",
    outbound: "Aller",
    inbound: "Retour",
    ...
    line: "La ligne",
    lineHint:
      "D’abord la ville, puis longue distance ou banlieue. Train, bus, direct ou correspondances.",
  },
  validation: {
    originRequired: "Choisissez une origine",
    cityRequired: "Choisissez d’abord une ville",
    ...
    originMustBeStation: "Choisissez une gare pour le tableau",
    returnTimeRequired: "Choisissez l'heure du retour",
    returnAfterOutbound: "Le retour doit partir après l'aller",
  },
  board: {
  ...
  alerts: {
    ...
    effects: {
      ...
      OTHER_EFFECT: "Avis de circulation",
      UNKNOWN_EFFECT: "Avis de circulation",
      STOP_MOVED: "Arrêt déplacé",
      NO_EFFECT: "Avis",
      ACCESSIBILITY_ISSUE: "Accès limité",
    },
  },
  ...
  results: {
    ...
    sortTransfersShort: "Changements",
    ...
    serviceTomorrow: "Demain dès {time}",
    lastTodayKicker: "Fin de service",
    lastToday: "Dernier aujourd’hui à {time}",
    lastOnBoard: "Dernier aujourd’hui",
