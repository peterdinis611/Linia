...
export const sk: Messages = {
  ...
  map: {
    ...
    tightTransfer: "Tesný prestup {name} · {minutes} min",
  },
  results: {
    departures: "Odchody",
    live: "Naživo",
    ...
    serviceTomorrow: "Zajtra od {time}",
    lastTodayKicker: "Koniec premávky",
    lastToday: "Posledný dnes o {time}",
    lastOnBoard: "Posledný dnes",
    walkTo: "{time} na {name}",
    walkTransfer: "{time} na prestup",
    toTop: "Na pult",
  ...
  detail: {
    ...
    tightTransfer: "prestup {minutes} min · tesné",
