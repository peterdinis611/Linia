...
export const it: Messages = {
  ...
  search: {
    ...
    modeCoach: "Bus",
    city: "Città",
    cityPlaceholder: "Prešov, Košice, Milano…",
    cityKicker: "Sportello città",
    cityHint: "Prima la città. Poi lunga percorrenza o suburbano.",
    suburbanHint: "Timbro da e per. La mappa appunta entrambe le fermate e la linea suburbana.",
    distanceGroup: "Tipo di linea",
    distanceLong: "Lunga percorrenza",
    distanceSuburban: "Suburbano",
    originSuburbanPlaceholder: "Paese o fermata",
    destinationSuburbanPlaceholder: "Capolinea della linea suburbana",
    ...
    pickFromList: "Scegli un luogo dall'elenco",
    noPlaces: "Nessun luogo. Prova una stazione o una città.",
    returnTrip: "Ritorno",
    ...
    line: "La linea",
    lineHint:
      "Prima la città, poi lunga percorrenza o suburbano. Treno, bus, diretti o con cambio.",
  },
  validation: {
    originRequired: "Scegli una partenza",
    cityRequired: "Scegli prima una città",
  ...
  map: {
    ...
    fold: "Chiudi la mappa",
    pocketKicker: "Carta a muro",
  ...
  results: {
    ...
    sortTransfersShort: "Cambi",
    resetFilters: "Azzera filtri",
    stale: "Gli orari potrebbero essere cambiati",
    onTheLine: "In viaggio",
    serviceFromKicker: "Buco nell'orario",
    serviceFromWait: "Prossima corsa tra {wait}",
    serviceFrom: "Servizio dalle {time}",
    serviceTomorrow: "Domani dalle {time}",
    lastTodayKicker: "Fine servizio",
    lastToday: "Ultimo oggi alle {time}",
    lastOnBoard: "Ultimo oggi",
    walkTo: "{time} a {name}",
  ...
  share: {
    ...
    boardOpen: "Condividi il tabellone",
    boardKicker: "Copia del tabellone",
    boardTitle: "Condividi questo tabellone",
    boardBody: "Invia un link pubblico alle partenze in diretta da questa fermata.",
  },
  recent: {
