...
export const nl: Messages = {
  ...
  search: {
    ...
    modeCoach: "Bus",
    city: "Stad",
    cityPlaceholder: "Prešov, Košice, Utrecht…",
    cityKicker: "Stadsloket",
    cityHint: "Eerst de stad. Daarna lange afstand of streek.",
    suburbanHint: "Stempel van en naar. De kaart speldt beide haltes en de streeklijn vast.",
    distanceGroup: "Soort lijn",
    distanceLong: "Lange afstand",
    distanceSuburban: "Streek",
    originSuburbanPlaceholder: "Dorp of halte",
    destinationSuburbanPlaceholder: "Eindpunt van de streeklijn",
    ...
    line: "De lijn",
    lineHint:
      "Eerst de stad, daarna lange afstand of streek. Trein, bus, direct of overstappen.",
  },
  validation: {
    originRequired: "Kies een vertrek",
    cityRequired: "Kies eerst een stad",
  ...
  results: {
    ...
    sortTransfersShort: "Overstappen",
    ...
    serviceTomorrow: "Morgen vanaf {time}",
    lastTodayKicker: "Einde dienst",
    lastToday: "Laatste vandaag om {time}",
    lastOnBoard: "Laatste vandaag",
